...
Nel caso in cui, l’articolo fosse gestito con unità di carico, e quindi, nel tab [confezionamento](/docs/erp-home/registers/items/create-new-items/item-registry/packaging) dell’anagrafica articolo deve essere presente almeno una riga con il flag **Unità di carico obbligatoria** attivo, la priorità e la quantità.     
