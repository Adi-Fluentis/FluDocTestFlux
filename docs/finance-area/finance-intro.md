...
<div className="cardContainer">
    <div className="card">
###     <Link to="/docs/finance-area/e-invoice/intro">Fatturazione elettronica</Link>
...
- [**Chiusura dei conti**](/docs/finance-area/ledger-records/records/automatic-account-closing/new-account-closing): procedura automatica con possibilità di riapertura automatica nell'esercizio successivo, riapertura delle scritture di assestamento, giroconto automatico utile perdita di esercizio.